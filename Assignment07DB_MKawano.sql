...
-- 2017-01-01,MKawano,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MKawano')
	 Begin 
	  Alter Database [Assignment07DB_MKawano] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MKawano;
	 End
	Create Database Assignment07DB_MKawano;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MKawano;
...
,[PreviousMonthCount] = IIF(InventoryDate Like ('January%'), 0, IsNull (Lag (InventoryCount)
 Over (Order By ProductName, Cast(InventoryDate As Date)), 0))
